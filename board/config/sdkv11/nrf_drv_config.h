...
//SDKV10 #define CLOCK_CONFIG_LF_RC_CAL_INTERVAL RC_2000MS_CALIBRATION_INTERVAL
#endif
...
// Changed from _LOW on 7/25/16 to ensure that we get counter interrupts
...
#define UART0_CONFIG_PSEL_TXD     TX_PIN
#define UART0_CONFIG_PSEL_RXD     RX_PIN
#define UART0_CONFIG_PSEL_CTS     CTS_PIN
#define UART0_CONFIG_PSEL_RTS     RTS_PIN
#define UART0_CONFIG_IRQ_PRIORITY APP_IRQ_PRIORITY_LOW

// Note the following current measurements on 08/23/2016 on naked Blueio board with NRF52/S132:
// 2.153mA EASY_DMA=true  EASY_DMA_SUPPORT=1 LEGACY_SUPPORT=0
// 0.497mA EASY_DMA=false EASY_DMA_SUPPORT=0 LEGACY_SUPPORT=1
#ifdef NRF52
